...
namespace HairApp.Controllers
{
    public class PeluquerosController : Controller
    {
        ...
        public PeluquerosController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Telefono,Email,Especialidad,Activo")] Peluquero peluquero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Telefono,Email,Especialidad,Activo")] Peluquero peluquero)
        {
            if (id != peluquero.Id)
            {
                return NotFound();
